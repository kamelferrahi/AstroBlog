        ...
        return (
            <div className="px-20 py-5 flex flex-col items-start justify-between">
                ...
                <div className='flex flex-col justify-center items-start w-full my-5'>
                    ...
                    <form action="http://localhost:5000" method="post" className='my-8 flex flex-col justify-center items-center w-full'>
                        ...
                        <div className='p-4 border border-boder-grey rounded-md bg-input-light-grey w-3/4 flex flex-row items-center justify-between mb-1'>
                            <input type="password" required name="password" placeholder='password' className='inline outline-0 bg-transparent font-text text-sm w-5/6' />
                        ...
                        <button type="submit" className='w-3/4 text-white rounded-md outline-none border-none bg-gradient-to-r from-light-pink to-dark-pink h-[50px] font-medium text-sm'>Login</button>
